...
SIP_BREAKDOWN = [
    {"name": "Nifty BEES (Large Cap)", "amt": 100000, "clr": "#52A2FF"},
    {"name": "Junior BEES (Next 50)",  "amt": 100000, "clr": "#57C785"},
    {"name": "Midcap / Smallcap Core", "amt": 150000, "clr": "#A37CFF"},
    {"name": "Arbitrage / GILT Mix",   "amt": 100000, "clr": "#46C1C1"},
    {"name": "Sprint Deployment (TBD)", "amt": 250000, "clr": "#E2CC8A"}
]
...
if tab == "Overview":
    ...
    with col2:
        st.markdown("<p style='font-size:11px; color:#C8A84B; font-weight:600; letter-spacing:1px; margin-bottom:15px;'>MONTHLY DEPLOYMENT (₹7L)</p>", unsafe_allow_html=True)
...
# ── TAB 2: PORTFOLIO ──────────────────────────────────────────────────────────
    ...
    fig = go.Figure(go.Pie(
        ...
        textfont=dict(size=14, color="#EAE3D6"),
